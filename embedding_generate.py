...
def embedding_generate(esm_model_path, fasta, embedding_result, nogpu):
    ...
    with torch.no_grad():
        for batch_idx, (labels, strs, toks) in enumerate(data_loader):
            ...
            out = esm_model(toks, repr_layers=[6], return_contacts=False)["representations"][6]
        ...
        print('embedding shape', esm_embedding.shape)
...
if __name__ == '__main__':
    ...
    #input
    parser.add_argument('-emp', '--esm_model_path', type=str, default='./model/esm2_t6_8M_UR50D.pt', help="ESM model location")
